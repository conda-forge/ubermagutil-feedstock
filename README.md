About ubermagutil-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ubermagutil-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7372&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ubermagutil-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ubermagutil` can be installed with `conda`:
...
```
mamba install ubermagutil
```

It is possible to list all of the versions of `ubermagutil` available on your platform with `conda`:
...
```
mamba search ubermagutil --channel conda-forge
```
...
mamba repoquery search ubermagutil --channel conda-forge

# List packages depending on `ubermagutil`:
mamba repoquery whoneeds ubermagutil --channel conda-forge

# List dependencies of `ubermagutil`:
mamba repoquery depends ubermagutil --channel conda-forge
```
